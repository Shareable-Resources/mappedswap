...
import TradeOrderRecord from "./TradeOrderRecord";
...
const TradeOrderRecords = ({historyRecordLastUpdated}) => {
    ...
    <>
      {data && data[0] ? (
        <InfiniteScroll
          ...
          scrollableTarget="scrollableOrder"
        >
...
export default TradeOrderRecords;
