#! /usr/bin/bash
# ▼▼▼▼▼▼▼▼ To run service in (testnet) enviroment in the running machine ▼▼▼▼▼▼▼▼
# sh ./2_runTestnet.sh
# or
# npm run testnet
# ▼▼▼▼▼▼▼▼ To run service in (testnet) enviroment in the running machine ▼▼▼▼▼▼▼▼
# sh ./2_runTestnet.sh agent
# sh ./2_runTestnet.sh dApp
# sh ./2_runTestnet.sh cronJob
# sh ./2_runTestnet.sh onlineDataFetcher
# or
# npm run testnet agent
# ▼▼▼▼▼▼▼▼ Wrong service is unavaliable ▼▼▼▼▼▼▼▼
# sh ./2_runTestnet.sh 123
