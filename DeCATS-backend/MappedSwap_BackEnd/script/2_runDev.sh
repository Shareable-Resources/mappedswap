#! /usr/bin/bash
# ▼▼▼▼▼▼▼▼ To run service in (dev) enviroment in the running machine ▼▼▼▼▼▼▼▼
# sh ./2_runDev.sh
# or
# npm run dev
# ▼▼▼▼▼▼▼▼ To run service in (dev) enviroment in the running machine ▼▼▼▼▼▼▼▼
# sh ./2_runDev.sh agent
# sh ./2_runDev.sh dApp
# sh ./2_runDev.sh cronJob
# sh ./2_runDev.sh onlineDataFetcher
# or
# npm run dev agent
...
deleteCmdPath="../node_modules/.bin/pm2 delete -n"
cmdStr=""
