import { EventParticipantController } from '../controller/0_index';
...
class Route extends CommonRoute {
  controller: EventParticipantController = new EventParticipantController();
  constructor() {
    super(logger);
    this.prefix = 'eventParticipants';
    this.setRoutes();
  }
