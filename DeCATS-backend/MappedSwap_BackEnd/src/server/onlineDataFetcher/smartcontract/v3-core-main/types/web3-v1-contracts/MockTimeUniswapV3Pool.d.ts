...
export interface MockTimeUniswapV3Pool extends BaseContract {
  ...
  methods: {
    ...
    positions(arg0: string | number[]): NonPayableTransactionObject<{
      liquidity: string;
    ...
    setFeeGrowthGlobal0X128(
      _feeGrowthGlobal0X128: number | string | BN
    ): NonPayableTransactionObject<void>;

    setFeeGrowthGlobal1X128(
      _feeGrowthGlobal1X128: number | string | BN
    ): NonPayableTransactionObject<void>;
    ...
    tickBitmap(arg0: number | string | BN): NonPayableTransactionObject<string>;
