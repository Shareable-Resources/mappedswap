...
export interface PriceAdjustBack extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): PriceAdjustBack;
  clone(): PriceAdjustBack;
  methods: {
    ...
    initialize(_pool: string): NonPayableTransactionObject<void>;

    getPool(): NonPayableTransactionObject<string>;

    setPool(poolAddr: string): NonPayableTransactionObject<void>;

    adjust(
      tokenName: string,
      tokenAddr: string,
      targetPrice: number | string | BN,
