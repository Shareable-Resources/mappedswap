...
import AgentDailyReportRealTime, {
  AgentDailyReportStatus,
} from '../dbModel/AgentDailyReport';
import * as SeqModel from './0_index';
export default AgentDailyReportRealTime;
export interface AgentDailyReportRealTimeModel
  extends Model<AgentDailyReportRealTime>,
    AgentDailyReportRealTime {}
export type AgentDailyReportRealTimeStatic = typeof Model & {
  new (values?: any, options?: BuildOptions): AgentDailyReportRealTimeModel;
};
export function AgentDailyReportRealTimeFactory(sequelize: Sequelize) {
  return <AgentDailyReportRealTimeStatic>sequelize.define(
