...
import { ResponseMesssage } from './../ws/WebSocketMessage';
import { ResponseBase } from './../api/ApiMessage';
import * as websocket from 'websocket';
import * as auth_message from './AuthMessage';
import * as ws_message from '../ws/WebSocketMessage';
...
export class AuthClient {
  ...
  protected sendMessage(
    ...
    console.log('request message: ', reqStr);
